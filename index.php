...
$sql = "SELECT * FROM plan WHERE prikazi_na_pocetnoj = 1";
...
<body>
    ...
    <div class="blur-bg-overlay"></div> <!--Za zamagljivanje pozadine stranice dok je popup aktivan-->
    <?php if (!isset($_SESSION['user'])): //Provera da li je korisnik prijavljen, ako nije ucitava se log in forma?>  
    ...
    <div class="container-header">
        <div class="p-3" style="max-width: 900px;">
            ...
            <h1 class="display-2 text-white text-uppercase mb-md-4">Build Your Body Strong With Gym</h1>
        </div>
    </div>
    <div class="buttons">
        <a href="planovi.php" class="btn btn-primary py-md-3 px-md-5 me-3">Pridruži se!</a>
        <a href="kontakt.php" class="btn btn-light py-md-3 px-md-5">Kontakt</a>
    </div>
    <div class="training">
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="go-corner">
                                <div class="go-arrow"><a href="planovi.php">→</a></div>
                            </div>
                        </div>
                    </div>';
                }
